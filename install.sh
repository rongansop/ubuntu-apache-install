...
PORT=80
PORTSSL=443
read -e -p "Enter php mumber version 5.6 or 7.0 or 7.1 or 7.3 or 7.4 or 8.0 or 8.1 or 8.2: " -i "$VERSION" VERSION
...
update-alternatives --install /usr/sbin/php-fpm php-fpm /usr/sbin/php-fpm5.6 90
update-alternatives --install /usr/sbin/php-fpm php-fpm /usr/sbin/php-fpm7.0 80
update-alternatives --install /usr/sbin/php-fpm php-fpm /usr/sbin/php-fpm7.1 70
update-alternatives --install /usr/sbin/php-fpm php-fpm /usr/sbin/php-fpm7.2 60
update-alternatives --install /usr/sbin/php-fpm php-fpm /usr/sbin/php-fpm7.3 50
update-alternatives --install /usr/sbin/php-fpm php-fpm /usr/sbin/php-fpm7.4 40
update-alternatives --install /usr/sbin/php-fpm php-fpm /usr/sbin/php-fpm8.0 30
update-alternatives --install /usr/sbin/php-fpm php-fpm /usr/sbin/php-fpm8.1 20
update-alternatives --install /usr/sbin/php-fpm php-fpm /usr/sbin/php-fpm8.2 10
